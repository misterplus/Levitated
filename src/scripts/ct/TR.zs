...
blastFurnace.addRecipe(<techreborn:dynamiccell>.withTag({Fluid: {FluidName: "fluidcalciumcarbonate", Amount: 1000}}), null, <ore:itemSlag>, <techreborn:dynamiccell>.withTag({Fluid: {FluidName: "dist_water", Amount: 1000}}), 300, 107, 1020);
