...
mods.techreborn.blastFurnace.removeInputRecipe(<techreborn:ingot:19>);
...
mods.techreborn.blastFurnace.addRecipe(<techreborn:ingot:12>, <techreborn:dust:15> * 2, <minecraft:iron_ingot>, <techreborn:dust:13> * 2, 400, 96, 1000);